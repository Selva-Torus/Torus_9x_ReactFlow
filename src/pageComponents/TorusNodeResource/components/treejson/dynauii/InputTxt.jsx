...
function InputTxt({
  ...
  useEffect(() => {
    if (selectedinput) console.log(typeof selectedinput);
  }, [selectedinput]);
                ...
                <div className="edit-tname">
                  ...
                  <div className="buttons-check">
                    <span className="save-btns">
                      <span
                        onClick={(e) => {
                          functionality("edit", path + "." + keys, keyvalue);
            ...
            {typeof obj[keys] === "boolean" ? (
              ...
              <>
                ...
                <span
                  ...
                  onClick={(e) => {
                    console.log("sjdhashdasudhasdh", typeof obj[keys]);
                    setSelectedinput(obj[keys]);
                  }}
                >
                  <FiEdit size={15} color="rgba(0,0,0,0.5)" />
                </span>
