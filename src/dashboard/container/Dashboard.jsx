...
import DecisionNode from "./customnode/DecisionNode";
import DefaultNode from "./customnode/DefaultNode";
import ApiNode from "./customnode/ApiNode";
...
import ModuleDetails from "./ModuleDetails/ProcessFlowModuleDetails";
const NODE_TYPE = {
  startNode: StartNode,
...
const Dashboard = ({ ten, applicationG, applicationV, admin }) => {
  ...
  useEffect(() => {
    (async () => {
      if (selectedApp) await applicationDetailsApi();
    })();
  }, [selectedApp]);
  // tosters
